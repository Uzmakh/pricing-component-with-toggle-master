...
--> import the google-fonts link for the Montserrat font for weights 400-regular and 700-bold
...
--> set the hover states of the buttons --> used flexbox for the layout
